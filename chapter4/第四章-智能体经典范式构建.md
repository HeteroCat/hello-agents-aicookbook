...
![ReAct 范式中的“思考-行动-观察”协同循环](/images/4-figures/4-1.png)
...
![Plan-and-Solve 范式的两阶段工作流](/images/4-figures/4-2.png)
...
![Reflection 机制中的“执行-反思-优化”迭代循环](/images/4-figures/4-3.png)
...
![至此，我们已经掌握了构建单个智能体的核心技术。为了过渡知识，以及对实际应用更加深入。下一节我们将会探索不同低代码平台的使用方式以及轻代码构建agent的方案。](/images/4-figures/4-4.png)
