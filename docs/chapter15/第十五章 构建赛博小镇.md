...
赛博小镇采用**游戏引擎+后端服务**的分离架构，分为四个层次，如图 15.1 所示。
  ...
  ![图 15.1 赛博小镇技术架构](/images/15-figures/15-1.png)
...
数据流转过程如图 15.2 所示：
  ...
  ![图 15.2 数据流转过程](/images/15-figures/15-2.png)
...
游戏启动后，你会看到一个像素风格的 Datawhale 办公室场景，如图 15.3 所示。
  ...
  ![图 15.3 赛博小镇游戏场景](/images/15-figures/15-3.png)
...
使用 WASD 键移动玩家角色，走到 NPC 附近时，屏幕上会显示"按 E 键交互"的提示。按下 E 键后，会弹出对话框，你可以输入任何想说的话，如图 15.4 所示。
  ...
  ![图 15.4 与 NPC 对话界面](/images/15-figures/15-4.png)
...
NPC Agent 的工作流程如图 15.5 所示：
  ...
  ![图 15.5 NPC Agent 工作流程](/images/15-figures/15-5.png)
...
记忆系统的架构如图 15.6 所示：
  ...
  ![图 15.6 记忆系统架构](/images/15-figures/15-6.png)
...
批量生成的工作流程如图 15.7 所示：
  ...
  ![图 15.7 批量生成 vs 传统模式](/images/15-figures/15-7.png)
...
我们将好感度分为五个等级，每个等级对应一个分数范围，如图 15.8 所示：
  ...
  ![图 15.8 好感度等级划分](/images/15-figures/15-8.png)
...
好感度计算流程如图 15.9 所示：
  ...
  ![图 15.9 好感度计算流程](/images/15-figures/15-9.png)
...
我们的 FastAPI 应用采用模块化设计，将不同的功能分离到不同的文件中，如图 15.10 所示:
  ...
  ![图 15.10 后端应用结构](/images/15-figures/15-10.png)
...
API 路由的调用流程如图 15.11 所示：
  ...
  ![图 15.11 API 调用流程](/images/15-figures/15-11.png)
...
让我们先看看四个核心场景的结构，如图 15.12 所示：
  ...
  ![图 15.12 赛博小镇的四个核心场景](/images/15-figures/15-12.png)
...
对话 UI 的结构如图 15.13 所示：
  ...
  ![图 15.13 对话 UI 结构](/images/15-figures/15-13.png)
...
整个前后端通信流程如图 15.14 所示：
  ...
  ![图 15.14 前后端通信完整流程](/images/15-figures/15-14.png)
...
整个项目的技术栈如图 15.15 所示：
  ...
  ![图 15.15 赛博小镇技术栈](/images/15-figures/15-15.png)
