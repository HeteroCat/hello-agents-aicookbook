...
3. 选择你的 GitHub 账号，创建 Fork
  ...
  ![图 16.1 Fork 仓库步骤](/images/16-figures/16-1.png)
...
```
  ...
  ![图 16.2 克隆仓库到本地](/images/16-figures/16-2.png)
...
3. 点击"New pull request"按钮
  ...
  ![图 16.3 创建 Pull Request](/images/16-figures/16-3.png)
...
如图 16.4 所示，点击"Create pull request"按钮提交。
  ...
  ![图 16.4 提交 Pull Request](/images/16-figures/16-4.png)
