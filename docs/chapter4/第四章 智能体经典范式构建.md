...
这个循环不断进行，将新的 $(a_t,o_t)$ 对追加到历史中，直到模型在思考 $th_t$ 中判断任务已完成。
  ...
  ![图 4.1 ReAct 范式中的“思考-行动-观察”协同循环](/images/4-figures/4-1.png)
...
最终的答案就是最后一个步骤的执行结果 $s_n$。
  ...
  ![图 4.2 Plan-and-Solve 范式的两阶段工作流](/images/4-figures/4-2.png)
...
![图 4.3 Reflection 机制中的“执行-反思-优化”迭代循环](/images/4-figures/4-3.png)
