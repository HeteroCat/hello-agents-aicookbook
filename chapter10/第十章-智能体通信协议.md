...
![MCP 设计思想](/images/10-figures/10-1.png)
...
![A2A 设计思想](/images/10-figures/10-2.png)
...
![ANP 设计思想](/images/10-figures/10-3.png)
...
![目前的协议还处于发展早期，MCP 的生态相对成熟，不过各种工具的时效性取决于维护者，更推荐选择大公司背书的 MCP 工具。](/images/10-figures/10-table-1.png)
...
![HelloAgents 通信协议设计](/images/10-figures/10-4.png)
...
![MCP 案例演示](/images/10-figures/10-5.png)
...
![让我们通过一个具体例子来理解 MCP 的完整工作流程，如图 10.6 所示：](/images/10-figures/10-table-2.png)


![MCP 案例演示](/images/10-figures/10-6.png)
...
![这里我们以智能体需要访问 GitHub 仓库和本地文件系统为例子来详细对比同一个任务的两种实现](/images/10-figures/10-table-3.png)
...
![社区热门 MCP 服务器](/images/10-figures/10-table-5.png)


![以下是一些特别有趣的案例 TODO 可供参考：](/images/10-figures/10-table-6.png)
...
![为实现对协作过程的管理，A2A 为任务定义了标准化的生命周期，包括创建、协商、代理、执行中、完成、失败等状态，可见图 10.7。](/images/10-figures/10-table-7.png)


![A2A 任务周期](/images/10-figures/10-7.png)
...
![A2A 请求生命周期](/images/10-figures/10-8.png)
...
![ANP 整体流程](/images/10-figures/10-table-8.png)
...
![Smithery 发布成功页面](/images/10-figures/10-10.png)
...
![Smithery 发布成功的 MCP 工具](/images/10-figures/10-11.png)
