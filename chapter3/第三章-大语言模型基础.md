...
![马尔可夫假设示意图](/images/3-figures/1757249275674-0.png)
...
![神经网络语言模型架构示意图](/images/3-figures/1757249275674-1.png)
...
![RNN 结构示意图](/images/3-figures/1757249275674-2.png)
...
![Transformer 整体架构图](/images/3-figures/1757249275674-3.png)
...
![多头注意力机制](/images/3-figures/1757249275674-4.png)
...
![下面我们用一段简单的 Python 代码来模拟上述过程：](/images/3-figures/1757249275674-5.png)
...
>>>
第1次合并: ('u', 'g') -> ug
新词表（部分）: ['h ug ', 'p ug ', 'p u n ', 'b u n ']
--------------------
第2次合并: ('ug', '') -> ug
新词表（部分）: ['h ug', 'p ug', 'p u n ', 'b u n ']
--------------------
第3次合并: ('u', 'n') -> un
新词表（部分）: ['h ug', 'p ug', 'p un ', 'b un ']
--------------------
第4次合并: ('un', '') -> un
新词表（部分）: ['h ug', 'p ug', 'p un', 'b un']
--------------------
